---
name: e2e-testing
description: 'E2E testing patterns, verification procedures, and CI readiness checklists. Use for writing, debugging, or reviewing end-to-end tests, fixing flaky tests, creating Page Objects, and mocking external APIs.'
---
...
- [ ] Passes in CI runner mode: `<project e2e command>`
