...
The plan has to include a dedicated code review phase at the end using the `code-review` skill.
...
Save the plan as a document following the `./references/plan.example.md` template.
